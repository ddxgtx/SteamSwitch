...
namespace SteamSwitcher.Services
{
    public class AppSettings
    {
        ...
        public bool SilentCloseSteam { get; set; }
    ...
    public static class SettingsService
    {
        ...
        private const string TaskName = "SteamSwitch";
        ...
        public static void SetStartWithWindows(bool enabled)
        {
            try
            {
                ...
                if (enabled)
                {
                    ...
                    var args = $"/Create /SC ONLOGON /TN \"{TaskName}\" /TR \"\\\"{exePath}\\\"\" /RL HIGHEST /F";
                    RunSchtasks(args);
                }
                else
                {
        ...
        private static void CleanupLegacyRunKey()
        {
            try
            {
                ...
                key?.DeleteValue("SteamSwitch", false);
            }
            catch
            {
                // ignore
