...
[Run]
Filename: "schtasks"; Parameters: "/Create /SC ONLOGON /TN ""SteamSwitch"" /TR """"{app}\{#MyAppExeName}"""" /RL HIGHEST /F"; Tasks: startwithwindows; Flags: runhidden
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent shellexec

[UninstallRun]
Filename: "schtasks"; Parameters: "/Delete /TN ""SteamSwitch"" /F"; Flags: runhidden
...
begin
  ...
  if (CurStep=ssPostInstall) then begin
    RegDeleteValue(HKCU, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Run', 'SteamSwitch');
  end;
end;
